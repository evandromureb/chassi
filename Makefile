...
init:
	...
	docker exec -it $(CONTAINER_NAME) chown -R www-data:www-data /var/www/html/storage /var/www/html/bootstrap/cache /var/www/html/config;
	docker exec -it $(CONTAINER_NAME) chmod -R 775 /var/www/html/storage /var/www/html/bootstrap/cache /var/www/html/config;
	docker exec -it $(CONTAINER_NAME) composer install;
	docker exec -it $(CONTAINER_NAME) npm install;
